...
#delete/close the image after the key pressed
...
saved_directory="C:/Users/Snehpreet/OneDrive/Desktop/Jetlearn/Open CV/LESSON_1/output"
...
cv2.imshow("Green Saturation Image",R)
cv2.waitKey(0)
